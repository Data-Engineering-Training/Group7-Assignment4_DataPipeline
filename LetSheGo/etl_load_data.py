...
DB_URI = 'postgresql://trestle:password123@localhost:5432/letshego_db'
...
csv_file_paths = [
    'letshego-db/accounts.csv',
    'letshego-db/branches.csv',
    'letshego-db/customers.csv',
    'letshego-db/employees.csv',
    'letshego-db/loans.csv',
    'letshego-db/payments.csv',
    'letshego-db/transactions.csv'
]
